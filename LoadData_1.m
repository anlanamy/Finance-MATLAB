...
[w_wsd_data_0,w_wsd_codes_0,w_wsd_fields_0,w_wsd_times_0,w_wsd_errorid_0,w_wsd_reqid_0]= ...
    w.wsd(windcode,'close',start_time,end_time,'PriceAdj=F');
...
[w_wsd_data_1,w_wsd_codes_1,w_wsd_fields_1,w_wsd_times_1,w_wsd_errorid_1,w_wsd_reqid_1]= ...
    w.wsd(windcode,'pct_chg',start_time,end_time,'PriceAdj=F');
...
[w_wsd_data_2,w_wsd_codes_2,w_wsd_fields_2,w_wsd_times_2,w_wsd_errorid_2,w_wsd_reqid_2]= ...
    w.wsd(windcode,'industry_CSRC12,industry_gics',start_time,start_time,'industryType=1','PriceAdj=F');
...
% 数据拼接
DB.Code = windcode;
DB.Info = w_wsd_data_2;%所属证监会行业名称，所属wind行业名称
